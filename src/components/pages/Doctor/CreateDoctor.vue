                    ...
                    <div class="card-body">
                        ...
                        <form class="form-sample">
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            <vs-input color="dark" label-placeholder="Joel" size="small"
                                                style="width:100%" />
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group row">
                                        <label class="col-sm-3 col-form-label">Last Name <span
                                                class="text-danger">*</span> </label>
                                        <div class="col-sm-9">
                                            <vs-input color="dark" label-placeholder="Rupiah" size="small"
                                                style="width:100%" />
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            <vs-input color="dark" label-placeholder="Jeremiah" size="small"
                                                style="width:100%" />
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group row">
                                        <label class="col-sm-3 col-form-label">Date of Birth <span
                                                class="text-danger">*</span> </label>
                                        <div class="col-sm-9">
                                            <el-date-picker color="dark" type="date" placeholder="Pick a day"
                                                size="default" style="width:100%;margin-top: 15px;" />
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group row">
                                        <label class="col-sm-3 col-form-label">Education <span
                                                class="text-danger">*</span> </label>
                                        <div class="col-sm-9">
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group row">
                                        <label class="col-sm-3 col-form-label">ID Number <span
                                                class="text-danger">*</span> </label>
                                        <div class="col-sm-9">
                                            <vs-input color="dark" label-placeholder="33498198" size="small"
                                                style="width:100%" />
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group row">
                                        <label class="col-sm-3 col-form-label">Mobile No. <span
                                                class="text-danger">*</span> </label>
                                        <div class="col-sm-9">
                                            <vs-input color="dark" label-placeholder="+254715733257" size="small"
                                                style="width:100%" />
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            <vs-input color="dark" label-placeholder="2342kj334rj4h" size="small"
                                                style="width:100%" />
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group row">
                                        <label class="col-sm-3 col-form-label">Visa No.</label>
                                        <div class="col-sm-9">
                                            <vs-input color="dark" label-placeholder="2342kj334rj4h" size="small"
                                                style="width:100%" />
                                        </div>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <vs-button @click.prevent="createDoctor" color="dark" type="filled" size="small">
                                        Create Doctor
                                    </vs-button>
...
export default {
    ...
    methods: {
        ...
        createDoctor(){
            Axios.post('http://127.0.0.1:8000/api/admin/create-doctor', this.form)
                .then(() => {})
                .catch(() => {})
        }
    },
